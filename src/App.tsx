            ...
            {(() => {
              ...
              return (
                <div className="max-w-3xl mx-auto mt-2">
                  <details className="bg-gray-50/50 rounded-lg">
                    <summary className="px-4 py-2.5 text-sm cursor-pointer hover:bg-gray-100/50 transition-colors flex items-center space-x-2">
                      <svg className="w-4 h-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
                      <span className="text-gray-600">引用來源 ({lastMessage.sources.length})</span>
                    </summary>
                    <div className="mt-2 space-y-2 p-4">
                      {lastMessage.sources.map((source, sourceIndex) => (
                        <div key={sourceIndex} className="bg-white rounded-lg p-3 shadow-sm">
                          ...
                          <p className="text-sm text-gray-600 whitespace-pre-wrap">{source.content}</p>
                        </div>
                      ))}
                    </div>
                  </details>
